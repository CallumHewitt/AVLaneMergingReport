...
In each of the scenarios in section \ref{sec:Merge Types} the road layout is fixed. More variance can be introduced to the scenarios by altering other factors.

\begin{itemize}
\item \textit{Traffic Level} The traffic level changes the number of vehciles which use 
\end{itemize}
