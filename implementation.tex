...
The results can be saved to a CSV file containing the throughput, maximum delay, average delay \todo{Make sure this is implemented} and minimum delay of the system. There are also results for each vehicle. Each result contains the vehicle's
\begin{itemize}
\item VIN
\item Starting Road
